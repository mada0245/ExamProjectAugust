...
<div>
  ...
  <br />
  <textarea id="recepiesDescription" bind:value={recepiesDescription}
  ></textarea><br /><br />

  <label for="recepiesPreparationTime">Preparation Time(seconds)</label>
  <br />
  <input
    type="number"
    id="recepiesPreparationTime"
    bind:value={recepiesPreparationTime}
  />
  ...
  <div class="ingredientesSelector">
    ...
    {:else}
      ...
      <AddNewRecepie
        nameToFetch={recepiesName}
        ingredientesToFetch={recepiesIngredientes}
        descriptionToFetch={recepiesDescription}
        preparationTimeToFetch={recepiesPreparationTime}
      />
    {/if}
  </div>
</div>
